...
export default function CreateAccountPage() {
    ...
    useEffect(() => {
        const t = setTimeout(() => setLegalVisible(true), 600);
    ...
    return (
        <div className="grid min-h-screen" style={{ gridTemplateColumns: '55fr 45fr' }}>
            <div className="relative flex items-center justify-center px-[36px] py-[48px]">
                <div className="w-full max-w-[360px] stagger-blur-fade-in">
                    ...
                    <div className="mb-[36px]">
                        ...
                        <p className="text-muted-foreground" style={{ fontSize: "15px" }}>
                            All-in-one app for your photography business.
                        </p>
                    </div>
                ...
                {/* Legal text — bottom-center of content area, fades in */}
                <p
                    className="absolute bottom-[20px] left-0 right-0 text-center text-muted-foreground pointer-events-none"
                    style={{
                        fontSize: "12px",
                        lineHeight: 1.6,
