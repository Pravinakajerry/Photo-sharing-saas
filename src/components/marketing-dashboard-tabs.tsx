            ...
            <div className="flex-1 w-full flex flex-col pt-[32px] pb-[100px]">
                ...
                >
                    {activeTab === "Clients" && clients.length > 0 ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center min-h-[400px] w-full animate-blur-fade-in">
                            <div className="flex flex-col items-center justify-center border border-border border-dashed rounded-[16px] bg-muted/20 p-[40px] text-center w-full max-w-[600px] mx-auto">
                                <div className="w-[64px] h-[64px] rounded-full bg-muted flex items-center justify-center mb-[24px]">
                                ...
                                <h3 className="text-foreground mb-[12px]" style={{ fontSize: "20px", fontWeight: 600 }}>Manage your clients effortlessly</h3>
                                <p className="text-muted-foreground mb-[32px] max-w-[420px]" style={{ fontSize: "15px", lineHeight: 1.6 }}>
                                    Keep your business organized. Add clients to securely share photography deliverables, manage feedback, and handle invoicing smoothly.
                                </p>
                                <button
                                    onClick={() => setClientModalOpen(true)}
                                    className="flex items-center gap-[8px] rounded-full bg-foreground text-background px-[24px] py-[12px] shadow-sm hover:scale-[1.02] active:scale-95 transition-all duration-300 cursor-pointer"
                                >
                                    <span style={{ fontSize: "14px", fontWeight: 500 }}>Add First Client</span>
                                </button>
                            </div>
                        </div>
                    ) : activeTab === "Profile" ? (
                        <div className="flex-1 flex flex-col items-center justify-center min-h-[400px] w-full animate-blur-fade-in">
                            <div className="flex flex-col items-center justify-center border border-border border-dashed rounded-[16px] bg-muted/20 p-[40px] text-center w-full max-w-[600px] mx-auto">
                                ...
                                <h3 className="text-foreground mb-[12px]" style={{ fontSize: "20px", fontWeight: 600 }}>Upload your first file</h3>
                                <p className="text-muted-foreground mb-[32px] max-w-[420px]" style={{ fontSize: "15px", lineHeight: 1.6 }}>
                                    Your profile is empty. Start building your portfolio by uploading high-quality images and sharing them with the world.
                                </p>
                                <button
                                    onClick={() => fileInputRef.current?.click()}
                                    className="flex items-center gap-[8px] rounded-full bg-foreground text-background px-[24px] py-[12px] shadow-sm hover:scale-[1.02] active:scale-95 transition-all duration-300 cursor-pointer"
                                >
                                    <span style={{ fontSize: "14px", fontWeight: 500 }}>Upload File</span>
                                </button>
                            </div>
                        </div>
                    ) : (
